...
class ControllerExtensionModulefeedback extends Controller {
	public function index($setting) {
        ...
        if (isset($this->error['fam'])) {
            $data['error_fam'] = $this->error['fam'];
        } else {
            $data['error_fam'] = '';
        }
        ...
        if (isset($this->request->post['fam'])) {
            $data['fam'] = $this->request->post['fam'];
        } else {
            $data['fam'] = $this->customer->getLastName();
        }
    ...
    protected function validate() {
        ...
        if ((utf8_strlen($this->request->post['fam']) < 3) || (utf8_strlen($this->request->post['fam']) > 32)) {
            $this->error['fam'] = $this->language->get('error_fam');
        }
